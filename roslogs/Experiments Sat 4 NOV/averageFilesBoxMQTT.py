...
plt.xticks([1, 2, 3, 4, 5, 6, 7, 8], ['MQTT - 1 MAV', 'MQTT - 2 MAVs', 'DDS - 3 MAVs', 'ROSTCP - 1 MAV', 'ROSTCP - 2 MAVs','ROSTCP - 3 MAVs', 'MQTT - 1 MAV','MQTT - 2 MAVs'])
